...
class TradingAgentsGraph:
    ...
    def _log_state(self, trade_date, final_state):
        ...
        self.log_states_dict[str(trade_date)] = {
            ...
            # The mandate's own analysts (Quality/Valuation, Momentum/Growth).
            # Lost once in the v0.5.0 merge, silently: a backtest cell's JSON
            # is the only place a sweep keeps their reports.
